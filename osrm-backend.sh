#!/bin/bash
export CATALOG="default"
export SCHEMA="routing"
export VOLUME="osrm_backend"
...
source /Volumes/default/routing/osrm_backend/osrm_env.sh
rm -rf "$LOCAL_OSRM"
...
do
  ...
  # test connectivity
  curl --silent "http://127.0.0.1:5000/route/v1/driving/-73.935242,40.730610;-74.005974,40.712776"
  res=$?
